package com.thermatrace.thermatracebackend.iam.infrastructure.security;
...
public class WebSecurityConfiguration {
    ...
    public WebSecurityConfiguration(BearerAuthorizationRequestFilter authorizationRequestFilter) {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of(
                "http://localhost:4200",
                "http://localhost:3000",
                "https://therma-trace.netlify.app"
        ));
